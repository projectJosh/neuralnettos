# experiment1.py
# runs naive bayes, id3 and c4.5 30 times on each of two datasets (monks1, opticalDigit)
...
print('C4.5 monks', sum(results[0][1])/len(results[0][1]))
print('NB monks', sum(results[0][2])/len(results[0][2]))

print('ID3 digits', sum(results[1][0])/len(results[1][0]))
print('C4.5 digits', sum(results[1][1])/len(results[1][1]))
